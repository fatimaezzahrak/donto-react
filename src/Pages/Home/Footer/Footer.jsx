    ...
    return (
        <div className="footer-bg">
                ...
                <Row className="text-white">
                    ...
                    <Col xs={6} md={3}>
                        <div className="single-footer-widget">
                            ...
                            <div className="widget-content">
                                <NavLink className="footer-link"> Dictionary</NavLink>
                    ...
                    <Col xs={6} md={3}>
                        <div className="single-footer-widget">
                            ...
                            <div className="widget-content">
                                <NavLink className="footer-link">Guelmim </NavLink>
                                <NavLink className="footer-link">Phone:06 03 79 85 45</NavLink>
                                <NavLink className="footer-link">Email:Hospy@gmail.com</NavLink>
                                <NavLink className="footer-link">Fax:05 26 78 87 65</NavLink>
                            </div>
                        </div>
                    </Col>
                </Row>
            ...
            <div className="footer-copy-right text-center text-white">
                <p className='mb-0'>&copy; 2022 - <span className="developer">krinda fatima ezzhra</span></p>
            </div>
        </div>
    );
};
